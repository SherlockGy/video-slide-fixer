...
| **语言一致性** | 文案为中文时，画面中**所有文字**（含插图标签、装饰性文字）都应为中文 | 出现英文而文案对应内容为中文（需翻译或删除）。**特别注意插图/装饰元素中混入的英文小标签**——它们不属于正文区域，容易被忽略 |
...
| **装饰性英文标签** | 齿轮旁"supply chain"、图标旁"logistics" | 插图/装饰元素中混入的英文小标签，不属于正文区域，视觉上不突出，容易漏检。应删除或替换为中文 |
